...
export { default as EventEmitter, EventEmitter, EventCallback } from '../utils/EventEmitter';
export { isTouch } from '../utils/observer';
export { resources } from '../utils/resources';
export { lenis, scroll } from '../utils/scroll';
export { sizes } from '../utils/sizes';
